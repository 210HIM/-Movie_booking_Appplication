...
{
    clrscr();
    print_title_in_middle("Movie Ticket Booking App",2,LIGHTMAGENTA);
...
void add_questions()
{
    FILE *fp=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Questions.bin","rb");
    if(fp==NULL)
    {
        fp=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Questions.bin","wb");
        if(fp==NULL)
        {
        ...
        char questions[][100] = {"Which adventurous sport does your father enjoy?", "Who is your favorite sports columnist?",
         "Which company would you like to work for in the future?", "What is the registration number of your first vehicle?",
         "What is the name of your best friend?", "Who is your favorite author?", "What is your favorite food?",
         "What is your favorite hobby?", "What is your favorite sport?", "Where did you meet your spouse?"};
        question ques[10];
        for(int i=0;i<=9;i++)
        {
...
{
    FILE *fp=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\users.bin","rb");
    if(fp==NULL)
    {
        fp=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\users.bin","wb");;
        if(fp==NULL)
        {
            print_char(' ',79,25,BLACK);
...
void get_string(char *str,unsigned int size)
{
    fflush(stdin);
    textcolor(RED);
...
user * login(char *usertype)
{
    ...
    for(int i=1;i<=3;i++)
    {
        ...
        {
            print_char(' ',79,25,BLACK);
            print_title_in_middle("Login Canceled",25,BLUE);
            getch();
            break;
        }
        else
        {
            ...
            else
            {
                if(i!=3)
                {
                    ...
                    if(strcmp(usertype,"master_admin")!=0)
                    {
                        print_title("Forget Username/Password?(y/n):",1,18,BROWN);
                        fflush(stdin);
                        textcolor(LIGHTRED);
                        scanf("%c",&choice);
...
char * get_question_id()
{
    ...
    while(fread(&que,sizeof(que),1,fp)==1){
        print_title(que.question_id,column_que_id,row_no,LIGHTRED);
...
{
    FILE *fp=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\users.bin","ab+");
    if(fp==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file Users.bin\n",1,25,RED);
...
int enter_login_choice()
{
    ...
    int col=32,row=10;
    print_title("1).Admin",col,row,YELLOW);
    print_title("2).User(Login)",col,++row,YELLOW);
    print_title("3).User(Sign-up)",col,++row,YELLOW);
    int valid=0,choice;
    do{
       ...
       {
           print_char(' ',79,25,BLACK);
           print_title_in_middle("Only Digit's Allow! try Again",25,RED);
           getch();
...
int enter_choice(user *ur)
{
    ...
    print_title(ur->usertype,1,5,YELLOW);
    print_title(ur->username,7,5,LIGHTCYAN);
...
void add_theater()
{
    ...
    clrscr();
    print_basic_screen();
    FILE *fp=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Theater.bin","ab+");
    if(fp==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file users.bin\n",1,25,RED);
    ...
    do{
        ...
        {
            print_char(' ',79,25,BLACK);
            print_title_in_middle("Canceling ADD Theater",25,RED);
            fclose(fp);
            getch();
            return;
        }
...
void show_theater()
{
    clrscr();
    print_basic_screen();
    FILE *fp=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Theater.bin","rb");
    if(fp==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file users.bin\n",1,25,RED);
...
char * get_theater_id(int status)
{
    ...
    while(fread(&th,sizeof(th),1,fp)==1)
    {
        if(th.is_booked==0)
        {
           print_title(th.theater_id,5,row,LIGHTRED);
           print_title(th.theater_name,20,row,YELLOW);
...
{
    FILE *fp1=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Bookings.bin","rb");
    if(fp1==NULL)
    {
        print_char(' ',79,25,BLACK);
    ...
    FILE *fp2=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TempBookings.bin","wb");
    if(fp2==NULL)
    {
        print_char(' ',79,25,BLACK);
    ...
    fclose(fp2);
    int x,y;
    x=remove("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Bookings.bin");
    if(x==0)
    {
        y=rename("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TempBookings.bin","E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Bookings.bin");
        if(y==0)
            return 1;
    }
    return 0;
...
{
    FILE *fp1=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Movie.bin","rb");
    if(fp1==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file Movie.bin\n",1,25,RED);
        perror("Reason:");
        getch();
        return 0;
    }
    FILE *fp2=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TempMovie.bin","wb");
    if(fp2==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file TempMovie.bin\n",1,25,RED);
        perror("Reason:");
        getch();
        fclose(fp1);
        return 0;
    ...
    while(fread(&mov,sizeof(mov),1,fp1)==1)
    {
        ...
        else
        {
            ...
            if(resp==0)
            {
                fclose(fp1);
                fclose(fp2);
                remove("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TempMovie.bin");
                getch();
                return 0;
            }
        }
    ...
    fclose(fp2);
    int x,y;
    x=remove("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Movie.bin");
    if(x==0)
    {
        y=rename("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TempMovie.bin","E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Movie.bin");
        if(y==0)
        {
            return 1;
        }
...
int  delete_theater()
{
   ...
   {
        print_char(' ',79,25,BLACK);
        print_title_in_middle("Canceling Delete Theater",25,RED);
        getch();
        return 0;
   }
   FILE *fp1=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Theater.bin","rb");
   if(fp1==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file Theaters.bin\n",1,25,RED);
   ...
   FILE *fp2=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TempTheaters.bin","wb");
    if(fp2==NULL)
    {
        print_char(' ',79,25,BLACK);
         ...
         else
         {
             if(th.is_booked==1)
             {
                 ...
                 if(resp==0)
                 {
                    fclose(fp1);
                    fclose(fp2);
                    remove("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TempTheaters.bin");
                    return 0;
                 }
             }
         }
    ...
    fclose(fp2);
    int x,y;
    x=remove("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Theater.bin");
    if(x==0)
    {
        y=rename("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TempTheaters.bin","E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Theater.bin");
        if(y==0)
            return 1;
    }
    return 0;
...
void add_movie()
{
    ...
    clrscr();print_basic_screen();
    FILE *fp=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Movie.bin","ab+");
    if(fp==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file Movie.bin\n",1,25,RED);
   ...
   do
   {
       ...
       {
           print_char(' ',79,25,BLACK);
           print_title_in_middle("Canceling Add Movie",25,RED);
           getch();
           return;
       }
...
{
    clrscr();print_basic_screen();
    FILE *fp=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Movie.bin","rb");
    if(fp==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file Movie.bin\n",1,25,RED);
    ...
    rewind(fp);
    int row=8;
    print_title("Theater Name",1,row,LIGHTBLUE);
    print_title("Movie Name",16,row,LIGHTBLUE);
    print_title("FIRST-B",35,row,LIGHTBLUE);
    print_title("SECOND-B",45,row,LIGHTBLUE);
    print_title("THERD-B",64,row,LIGHTBLUE);
    movie mov;
    row+=2;
    char prv_mov[100]={" "};
    char temp[100];
    ...
    {
        if(strcmp(prv_mov,mov.movie_name)!=0)
        {
            print_title(get_teaterid(mov.theater_id),2,row,YELLOW);
            print_title(mov.movie_name,16,row,YELLOW);

            sprintf(temp,"%d",mov.first_block_price);
            print_title(temp,35,row,YELLOW);

            sprintf(temp,"%d",mov.second_block_price);
            print_title(temp,45,row,YELLOW);

            sprintf(temp,"%d",mov.third_block_price);
            print_title(temp,64,row,YELLOW);

            strcpy(prv_mov,mov.movie_name);
            row++;
        }
    }
    fclose(fp);
...
void change_contact_details(user *u)
{
    ...
    {
        print_char(' ',79,25,BLACK);
        print_title_in_middle("Canceling Change Contact Details",25,RED);
        getch();
    }
    else if(choice=='Y'||choice=='y')
    {
        ...
        // code to edit the mob no
                ...
                print_char(' ',79,25,BLACK);
                print_title_in_middle(u->mobile_number,23,GREEN);
...
void change_password(user *u)
{
    ...
    {
        print_char(' ',79,25,BLACK);
        print_title_in_middle("Canceling Change Password",25,RED);
        getch();
    }
    else if(choice=='Y'||choice=='y')
    {
       ...
       if(strcmp(us.password,"0")==0)
       {
           ...
           return;
            ...
            {
                if(strcmp(u->userid,up.userid)==0)
                    {
            ...
            print_title_in_middle(u->password,24,GREEN);
            print_char(' ',79,25,BLACK);
            print_title_in_middle("Password change successfully !",25,LIGHTGREEN);
            getch();
...
void change_security_question(user *u)
{
    ...
    char ans[100];
    char choice;
    print_title_in_middle("Are you sure to change hint answer: (Y/y/N/n):",10,YELLOW);
    fflush(stdin);
    scanf("%c",&choice);
    if(choice=='n'|| choice=='N')
    {
    ...
    else if(choice=='Y'||choice=='y')
    {
       ...
       if(id==NULL)
       {
           fclose(fp);
           print_char(' ',79,25,BLACK);
           print_title_in_middle("Canceling Change security question",25,RED);
           getch();
           return;
       }
       else
       {
           int valid=0;
               do{
               print_title("Enter Answer : ",25,24,BROWN);
               getch();
               get_string(ans,100);
               if(strcmp(ans,"0")==0)
              {
                ...
                {
                    print_char(' ',79,25,BLACK);
                    print_title_in_middle("Hint Answer can not be blank .Please Try Again",25,RED);
                    getch();
                    print_char(' ',79,25,BLACK);
            ...
            while(fread(&up,sizeof(up),1,fp)==1)
            {
                    if(strcmp(u->userid,up.userid)==0)
                    {
                        strcpy(u->question_id,id);
                        strcpy(u->hint_answer,ans);
                        fseek(fp,-(long long signed int)sizeof(user),SEEK_CUR);
                        fwrite(u,sizeof(user),1,fp);
                        fclose(fp);
                        break;
            ...
            clrscr();print_basic_screen();
            print_title_in_middle("Hint Question change successfully !",13,LIGHTGREEN);
            getch();
...
int get_movie_id()
{
    ...
    int row=8;
    print_title("Movie ID",5,row,LIGHTBLUE);
    print_title("Movie Name",20,row,LIGHTBLUE);
    print_title("Booking Status",40,row,LIGHTBLUE);
    print_title("Theater Name",60,row,LIGHTBLUE);
    movie th,mov;
    rewind(fp);
    char th_id[100];
    char *p;
    ...
    while(fread(&th,sizeof(th),1,fp)==1)
    {
        if(strcmp(prv_mov,th.movie_name)!=0)
        {
             p=get_teaterid(mov.theater_id);

            print_title(th.movie_id,6,row,LIGHTRED);
            print_title(th.movie_name,21,row,YELLOW);
            p=get_teaterid(th.theater_id);
            print_title(th.theater_id,41,row,YELLOW);
            print_title(p,61,row,YELLOW);

            strcpy(prv_mov,th.movie_name);
            row++;
        }
    }
    int valid=0;
    ...
    do
    {
        print_title("Enter movie ID: MOVIE-",28,23,BROWN);
        get_integer(&id);
        if(id==0)
        {
            print_title_in_middle("Canceling Delete Movie in local",25,RED);
            fclose(fp);
            getch();
            return 0;
        }
        ...
        {
             sprintf(th_id,"MOVIE-%d",id);
             rewind(fp);
             char prv_mov2[100]={" "};
             while(fread(&th,sizeof(th),1,fp)==1)
             {
                 if(strcmp(prv_mov2,th.movie_name)!=0)
                 {
                    if (strcmp(th.movie_id,th_id)==0)
                    {
                        valid=1;
                        break;
                    }
                    strcpy(prv_mov2,th.movie_name);
                 }
             }
             if(valid==0)
             {
...
int delete_movie()
{
    ...
    while(fread(&mov,sizeof(mov),1,fp)==1)
     {
         if(strcmp(prv_mov,mov.movie_name)!=0)
             {
                if (strcmp(mov.movie_id,movie_id)==0)
                {
                    break;
                }
                strcpy(prv_mov,mov.movie_name);
    ...
    int y;
    change_theater_booking_status(mov.theater_id);
    y=delete_movie_by_theater_id(mov.theater_id);
    if(y==0)
    {
        print_char(' ',79,25,BLACK);
        print_title_in_middle("Canceling Delete Movie ",25,RED);
        getch();
        return 0;
    }
...
movie * get_movie_id_and_show_date()
{
    ...
    while(fread(&mov,sizeof(mov),1,fp)==1)
    {
        ...
        {
            print_title(mov.movie_id,1,row,LIGHTRED);
        ...
        if(valid==1)
        {
            ...
            while(fread(&mov,sizeof(mov),1,fp)==1)
            {
                if(strcmp(mov.movie_id,mov_id)==0)
                {
                    ...
                    print_title(temp_str,40,row,LIGHTRED);
                    row++;
                }
            }
            valid=0;
...
int * get_seat_numbers(movie * m)
{
    ...
    FILE * fp = fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\SeatNumbers.bin", "wb+");
    if(fp == NULL)
    {
        print_char(' ', 79, 25, BLACK);
    ...
    do
    {
        ...
        do
        {
            ...
            if(seat_number==0)
            {
                ...
                fclose(fp);
                getch();
                if(remove("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\SeatNumbers.bin"))
                {
                    print_char(' ', 79, 25, BLACK);
    ...
    if(p==NULL)
    {
        ...
        getch();
        fclose(fp);
        remove("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\SeatNumbers.bin");
        return NULL;
    }
    rewind(fp);
...
void change_seat_booking_status(int seat_number,char *mov_id,struct tm date)
{
    ...
    {
        print_char(' ', 79, 25, BLACK);
        print_title("Error in opening file Movie.bin booking(user * u)", 1, 25, RED);
        perror("Error");
        getch();
        return;
    }
...
void booking(user * u)
{
    ...
    {
        print_char(' ', 79, 25, BLACK);
        print_title_in_middle("Canceling Booking!",25, RED);
        getch();
        free(seat_numbers);
        return;
    }
    FILE * fp = fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Bookings.bin", "ab+");
    if(fp == NULL)
    {
        print_char(' ', 79, 25, BLACK);
...
void view_booking(user *u)
{
    print_basic_screen();
    FILE *fp=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Bookings.bin","rb");
    if(fp==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file Bookings.bin\n",1,25,RED);
    ...
    {
        print_char(' ',79,25,BLACK);
        print_title_in_middle("No booking  Present In The File",25,RED);
        fclose(fp);
        getch();
        return;
    }
            ...
            rewind(fp);
            char temp_str[100];
            print_title("Ticket ID",1,row,LIGHTBLUE);
            print_title("Theater ID",12,row,LIGHTBLUE);
            print_title("Movie ID",24,row,LIGHTBLUE);
            print_title("Seat No",34,row,LIGHTBLUE);
            print_title("Show Date",45,row,LIGHTBLUE);
            row+=2;
            while(fread(&tk,sizeof(tk),1,fp)==1)
            {
                if (strcmp(u->userid,tk.user_id)==0){
                print_title(tk.ticket_id,1,row,YELLOW);
                print_title(tk.theater_id,12,row,YELLOW);
                print_title(tk.movie_id,24,row,YELLOW);
...
void cancel_booking(user *u)
{
    ...
    do
    {
        ...
        {
            sprintf(th_id,"TICKET-%d",id);
            rewind(fp1);
             while(fread(&th,sizeof(th),1,fp1)==1)
             {
                 if (strcmp(th.ticket_id,th_id)==0)
                 {
                     valid=1;
                     change_seat_booking_status(th.seat_number,th.movie_id,th.show_date);
                 }
             }
             if(valid==0)
             {
    ...
    while(fread(&tk,sizeof(tk),1,fp1)==1)
    {
        if((strcmp(tk.ticket_id,th_id))!=0)
        {
            fwrite(&tk,sizeof(tk),1,fp2);
        }
    }
    ...
    if(x==0)
    {
        ...
        {
            print_char(' ',79,25,BLACK);
            print_title_in_middle("Booking cancel !",25,LIGHTGREEN);
            getch();
            return;
        }
    }
        ...
        print_char(' ',79,25,BLACK);
        print_title_in_middle("Booking not cansle !",25,LIGHTGREEN);
        getch();
        return;
    }
    return;
...
int delete_my_Account(user *u)
{
    ...
    {
        print_char(' ',79,25,BLACK);
        print_title_in_middle("Canceling Delete Account Process",25,RED);
        getch();
    }
    else if(choice=='Y'||choice=='y')
    {
            FILE *fp1=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\users.bin","rb");
            if(fp1==NULL)
            {
                print_char(' ',79,25,BLACK);
                print_title("Error in opening the file Bookings.bin\n",1,25,RED);
            ...
            FILE *fp2=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TEMPusers.bin","wb");
            if(fp2==NULL)
            {
                print_char(' ',79,25,BLACK);
                print_title("Error in opening the file Bookings.bin\n",1,25,RED);
            ...
            //bookinng
            FILE *fp3=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Bookings.bin","rb");
            if(fp3==NULL)
            {
                print_char(' ',79,25,BLACK);
                print_title("Error in opening the file Bookings.bin\n",1,25,RED);
            ...
            FILE *fp4=fopen("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\TempBookings.bin","wb");
            if(fp4==NULL)
            {
                print_char(' ',79,25,BLACK);
                print_title("Error in opening the file Bookings.bin\n",1,25,RED);
            ...
            user us;
            rewind(fp1);
            while(fread(&us,sizeof(us),1,fp1)==1)
            {
                if(strcmp(u->userid,us.userid)!=0)
                {
                    fwrite(&us,sizeof(us),1,fp2);
                }
            }
            fclose(fp1);
            fclose(fp2);
            ...
            ticket tk;
            char th_id[100];
            while(fread(&tk,sizeof(tk),1,fp3)==1)
            {
                if(strcmp(u->userid,tk.user_id)!=0)
                {
                    fwrite(&tk,sizeof(tk),1,fp4);
                }
                if(strcmp(u->userid,tk.user_id)==0)
                {
                    change_seat_booking_status(tk.seat_number,tk.movie_id,tk.show_date);
                    strcpy(th_id,tk.theater_id);
                }
            }
            change_theater_booking_status(th_id);
            fclose(fp3);
            fclose(fp4);
            int x,y;
            x=remove("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Bookings.bin");
            if(x==0)
            {
                ...
                if(y==0)
                {
                    x=remove("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\users.bin");
                    if(x==0)
                        {
                            y=rename("E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\Tempusers.bin","E:\\c project\\MovieTicketBooking\\Movie Ticket booking\\users.bin");
                            if(y==0)
                            {
                                print_char(' ',79,25,0);
                                print_title_in_middle("Your Account Delete successfully !",25,LIGHTGREEN);
                                getch();
                                return 0;
                            }
                            else{
...
void forget_credentials(char *usertype)
{
    ...
    do
    {
           ...
           print_title("Enter User ID:",col,12,BROWN);
           get_string(us.userid,100);
            if(strcmp(us.userid,"0")==0)
            {
                fclose(fp);
                return;
            }
            ...
            {
                print_char(' ',79,25,BLACK);
                print_title_in_middle("Error! User Id Is Incorrect. Please Try Again",25,RED);
                getch();
                print_char(' ',79,25,BLACK);
                print_char(' ',79,8,BLACK);
            }
            else
                valid=1;
    }while(valid==0);
     ...
     do
    {
        ...
        print_title("Enter your mobile number: +91-",col,14,BROWN);
        get_string(us.mobile_number,20);
        if(strcmp(us.mobile_number,"0")==0)
        {
            return ;
        }
        if(is_valid_integer(us.mobile_number)==0 || strlen(us.mobile_number)!=10)
        {
            print_char(' ',79,25,BLACK);
            print_title_in_middle("Error! Mobile Number Is Incorrect. Please Try Again",25,RED);
            getch();
            print_char(' ',79,25,BLACK);
            print_char(' ',79,14,BLACK);
        }
        else
            valid=1;
    }while(valid==0);
    ...
    while(fread(&u,sizeof(u),1,fp)==1)
    {
        if(strcmp(usertype,u.usertype)==0)
        {
            if((strcmp(us.userid,u.userid)==0) && (strcmp(us.mobile_number,u.mobile_number)==0))
            {
                status=1;
            }
            else{
                fclose(fp);
                print_char(' ',79,25,BLACK);
                print_title_in_middle("Canceling  Forget credentials Invalid Password/Mobile number",25,RED);
                getch();
                return ;
    ...
    if (status==1)
    {
        temp=get_question_id();
        if(us.question_id==NULL){
            return ;
        }
        strcpy(us.question_id,temp);
        valid=0;
        do{
            print_title("Enter Hint Answer:",25,24,BROWN);
            get_string(us.hint_answer,100);
            if(strcmp(us.hint_answer,"0")==0)
                return ;
            if(strlen(us.hint_answer)>=1)
            {
                valid=1;
            }
            else
    ...
    while(fread(&u,sizeof(u),1,fp)==1)
    {
        if(strcmp(usertype,u.usertype)==0)
        {
            if((strcmp(us.hint_answer,u.hint_answer)==0) && (strcmp(us.question_id,u.question_id)==0))
            {
                status=1;
            }
            else{
    ...
    if (status==1)
    {
       ...
       if(strcmp(us.password,"0")==0)
       {
           fclose(fp);
           print_char(' ',79,25,BLACK);
           print_title_in_middle("Canceling Forget Password",25,RED);
           getch();
           return;
       }
            rewind(fp);
            while(fread(&u,sizeof(u),1,fp)==1)
            {
                if(strcmp(u.usertype,usertype)==0)
                    {
                        strcpy(u.password,us.password);
            ...
            print_char(' ',79,25,BLACK);
            print_title_in_middle("Password reset successfully !",25,LIGHTGREEN);
            getch();
    }
